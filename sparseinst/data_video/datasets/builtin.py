...
_PREDEFINED_SPLITS_OVIS = {
    "Ovis_train": ("/mnt/workspace/SparseInst/Ovis/train",
                   "/mnt/workspace/SparseInst/Ovis/annotations/annotations_train.json"),
    "Ovis_valid": ("/mnt/workspace/SparseInst/Ovis/valid",
                   "/mnt/workspace/SparseInst/Ovis/annotations/annotations_valid.json"),
    "Ovis_test": ("/mnt/workspace/SparseInst/Ovis/test",
                  "/mnt/workspace/SparseInst/Ovis/annotations/annotations_test.json"),
}
...
if __name__.endswith(".builtin"):
    ...
    register_all_Ovis("/mnt/workspace/SparseInst/Ovis")