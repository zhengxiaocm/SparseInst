...
def _get_Ovis_instances_meta():
    ...
    # Mapping from the incontiguous OVIS category id to an id in [0, 39]
    thing_dataset_id_to_contiguous_id = {k: i for i, k in enumerate(thing_ids)}
...
if __name__ == "__main__":
    ...
    json_file = "/mnt/workspace/SparseInst/Ovis/annotations/annotations_train.json"
    image_root = "/mnt/workspace/SparseInst/Ovis/train"
    dicts = load_ytvis_json(json_file, image_root, dataset_name="Ovis")
